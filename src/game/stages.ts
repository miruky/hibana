...
// 31ステージ(通常20 + ⑥ゾンビ専用10=z01〜z10 + 訓練専用1)。
...
const STAGE_DEFINITIONS: StageDef[] = [
  ...
  },
  {
    ...
    recipe: {
      theme: '夕陽の巨大西洋修道城+外郭+大聖堂+二階回廊+城下街',
      // 修道城単体で複数の建物アーキタイプ分の面積と導線を持つ。
      // 別の要塞を自動配置すると城下町と入城射線を塞ぐため中央城に統合。
      buildings: ['abbey'],
      objects: [
  ...
  },
  {
    ...
    recipe: {
      theme: '崩壊した巨大西洋修道城+破断尖塔+荒廃回廊+城下墓地',
      buildings: ['abbey'],
      objects: [
        { kind: 'rubble', count: 6, scatter: 'random' },
        { kind: 'stonelantern', count: 4, scatter: 'random' },
